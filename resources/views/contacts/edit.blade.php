...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><div style="float: left"> <strong>{{ $contact->contact_name }} redagavimas </div> </strong> <div style="float: right"> <a class="btn btn-primary" href="{{ route('clients.show', $contact->client_id) }}" > {{ __('Grįžti') }} </a> </div> </div>
