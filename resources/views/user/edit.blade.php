...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><div style="float: left"> <strong>{{ $user->name }} redagavimas </div> </strong> <div style="float: right"> <a class="btn btn-primary" href="{{ route('user.show', $user->id) }}" > <i class="fas fa-arrow-left"></i> </a> </div> </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <strong> Profilio nuotrauka: </strong>
